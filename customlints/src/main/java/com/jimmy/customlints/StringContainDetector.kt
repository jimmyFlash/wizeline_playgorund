 ...
 * the word "lint".
 */
class StringContainDetector : Detector(), Detector.UastScanner{
    ...
    override fun createUastHandler(context: JavaContext): UElementHandler? {
        // Note: Visiting UAST (Universal Abstract Syntax Tree) nodes is a pretty general purpose mechanism;
    ...
    companion object {
        ...
        val ISSUE: Issue = Issue.create(
            ...
            implementation = Implementation(
                StringContainDetector::class.java,
